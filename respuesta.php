...
<head>
	<title>Agente Adivinador IA2</title>
...
function formularioRespuesta($n,$p){
	...
	echo "<h2>¿Qué característica tiene este juagador que no tenga ".$p."?</h2>";
...
//SI HA ACERTADO
	...
	echo "<h2> GRACIAS POR JUGAR A ADIVINADOR DE JUGADORES CAMPEONES DEL MUNDO IA2 </h2>";
}
...
<?php
	...
	echo "<br><br><a href='datos.php'>Datos de Agente Adivinador IA2</a>";
?>
